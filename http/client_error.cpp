...
ClientErrorToString(HTTP::ClientError error) {
	std::array array = {
		...
		"HOST_HEADER_ILLEGAL_PORT",
		"HOST_HEADER_INCORRECT",
		"HOST_HEADER_INCORRECT_PORT",
		"HOST_HEADER_MANY",
		"HOST_HEADER_NONE",
		...
		"INCORRECT_METHOD",
		"INCORRECT_PATH",
		"INCORRECT_PATH_ABSOLUTE_FORM",
		"INCORRECT_CRLF",
		"INCORRECT_VERSION",
		"INVALID_PATH_EMPTY",
		"INVALID_PATH_NOT_ABSOLUTE",
		"NO_ERROR",
		"POLICY_TOO_LONG_HEADER_FIELD_NAME",
		"POLICY_TOO_LONG_HEADER_FIELD_VALUE",
